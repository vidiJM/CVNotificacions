...
/**
 * Classe auxiliar per enviar peticionas al servidos i rebre respostes
 */
public class Httppostaux{
    ...
    public JSONArray getserverdata(ArrayList<NameValuePair> parameters, String urlwebserver ){
        // Connexio HTTP-POST al servidor amb els parametres
    ...
    public void getpostresponse(){
        // Transformen la resposta a String
        try{
